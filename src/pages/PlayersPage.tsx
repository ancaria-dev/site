      ...
      <div className={styles.container}>
        <section className={styles.section}>
          ...
          <ol className={styles.steps}>
            <li>
              Download <code>{latestRelease.fileName}</code> from the{' '}
              <a href={latestRelease.downloadUrl} target="_blank" rel="noreferrer">
                launcher releases
              </a>
              .
            </li>
            ...
            <li>
              ...
              Get Java to download one -- it is written only inside the game folder, nothing is
        ...
        <section className={styles.section}>
          ...
          <p>
            ...
            launcher's source settings. It gets merged into the Available list next to the default
            one, so nothing you already installed is affected.
          </p>
        </section>
        ...
        <Callout label="Read before you play" tone="crimson">
          <p>
            ...
            close the game, and it is as if the loader was never there.
          </p>
        </Callout>
