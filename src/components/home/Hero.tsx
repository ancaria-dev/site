  ...
  return (
    <section className={styles.hero}>
      ...
      <p className={styles.lede}>
        Ancaria loads mods into Sacred Gold while the game runs. Pick mods in the launcher and press
        Play, or write your own in Java, Kotlin, or Groovy. Your game files stay untouched.
      </p>
