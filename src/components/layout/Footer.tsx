    ...
    <footer className={styles.footer}>
      <div className={styles.grid}>
        <div>
          ...
          <p className={styles.tagline}>A mod loader for Sacred Gold. Single-player only.</p>
        </div>
        ...
        <div className={styles.column}>
          ...
          <p className={styles.credits}>
            ...
            , and on the community that keeps a 2004 game alive.
          </p>
        </div>
      </div>
      ...
      <div className={styles.legal}>
        <p>
          ...
          by, or connected to Ascaron Entertainment, THQ Nordic, or any other rights holder of
          Sacred or Sacred Gold. You need your own legally owned, installed copy of the game.
          Ancaria ships no game files, no executables, and no DRM circumvention. It changes nothing
          on disk: its hooks live only in the running game and vanish when it closes. It’s for
          single-player use only, with no multiplayer and no competitive advantage.
        </p>
