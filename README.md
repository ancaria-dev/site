...
Скриншоты в `src/assets/screenshots/` пока залиты одним цветом. Каждый файл
назван по тому, что на нём появится: `launcher.webp`, `ingame.webp` и так далее.
Чтобы вставить настоящий снимок, замените файл с тем же именем. Подписи лежат в
